...
from spatium.clients.rest_client import DeviceSpecificRestClient, RestClient
...
class TestRestClient:
    ...
    def rest_client(self):
        ...
        return RestClient(
            host="test-device", username="admin", password="password", port=8080, timeout=10
        )
...
class TestDeviceSpecificRestClient:
    ...
    async def test_get_config_arista(self):
        ...
        mock_response_data = {"result": [{"output": "version 4.20.1F"}]}
