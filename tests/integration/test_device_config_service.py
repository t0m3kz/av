...
from spatium.api.responses import DeviceConfigResult
...
class TestDeviceConfigServiceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_fetch_configs_bulk_mixed_methods(self, config_service, mock_ssh_client_factory, mock_rest_client_factory):
