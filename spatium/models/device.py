...
class DeviceCredentials(BaseModel):
    ...
    method: Literal["ssh", "gnmi", "both"] = Field("both", description="Configuration retrieval method")
    ...
    gnmi_paths: Optional[List[str]] = Field(None, description="List of gNMI paths to query")
