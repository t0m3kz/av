...
from spatium.api import deployment, device
...
app = FastAPI(
    title="Spatium API",
    description=(
        "Network automation and analysis platform for SSH-based device management "
...
def health_check() -> dict[str, str]:
    ...
    return {"status": "healthy", "version": settings.APP_VERSION, "service": "spatium-api"}
