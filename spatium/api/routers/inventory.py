...
from spatium.api.exceptions import create_http_exception, InventoryError
...
async def add_devices_to_inventory(
    ...
    """Add one or more devices to the specified inventory."""
    try:
        ...
        raise create_http_exception(422, f"Validation error: {e}")
    except Exception as e:
        logger.error(f"Error adding devices to inventory {inventory}: {e}")
        raise create_http_exception(500, f"Failed to add devices: {e}")
...
def list_devices_in_inventory(
    ...
    try:
        ...
        raise create_http_exception(500, f"Failed to list devices: {e}")
...
async def remove_devices_from_inventory(
    ...
    """Remove one or more devices from the specified inventory."""
    try:
        data = await request.json()
        ...
        raise create_http_exception(500, f"Failed to remove devices: {e}")
...
def clear_inventory(
    ...
    try:
        ...
        raise create_http_exception(500, f"Failed to clear inventory: {e}")
...
def list_inventory_names(
    ...
    try:
        ...
        raise create_http_exception(500, f"Failed to list inventory names: {e}")
...
def get_inventory_stats(
    ...
    try:
        ...
        raise create_http_exception(500, f"Failed to get inventory stats: {e}")
